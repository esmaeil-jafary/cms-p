...
<!-- Start Footer -->
<footer>
    <div class="footer-area" style="background-image:url(assets/images/footer_bg.jpg);" data-aos="fade-up">
        <div class="container section-ptb">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-6">
                    <div class="single-widget">
                        <h3 class="mb-4">لینک های سریع</h3>
                        <div class="widget-list">
                            <ul>
                                <li><a href="#">درباره شرکت</a></li>
                                <li><a href="#">ملاقات با تیم</a></li>
                                <li><a href="#">مشتریان</a></li>
                                <li><a href="#">پروژه ما</a></li>
